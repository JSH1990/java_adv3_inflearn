...
public class OrElseGetMain {
    public static void main(String[] args) {
        ...
        Object i2 = optEmpty.orElse(10 + 20); //10 + 20 계산후 사용
        ...
        Integer value2 = optEmpty.orElse(createDate());
        System.out.println("value2 = " + value2);

        //값이 있으면 그 값, 없으면 지정된 람다 사용
        System.out.println("=== orElseGet ===");
        System.out.println("값이 있는 경우");
        Integer value3 = optValue.orElseGet(() -> createDate());
        System.out.println("value3 = " + value3);
        System.out.println("값이 없는 경우");
        Integer value4 = optEmpty.orElseGet(() -> createDate());
    ...
    static int createDate(){
        ...
        System.out.println("데이터 생성이 완료 되었습니다. 생성 값 : " + createValue);
        return createValue;
    }
}
